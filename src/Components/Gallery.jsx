    ...
    <>
      <section id="gallery" style={{background:props.bg}}>
        <div className="container">
          <h4 data-aos="fade-up" style={{color:props.title1}}>{t("gallery.0")}</h4>
          <h3 data-aos="fade-up" style={{color:props.title2}}>{t("gallery.1")}</h3>
          ...
          <button data-aos="fade-up" style={{background:props.button, color:props.buttonColor}}>{t("tasty.2")}</button>
        </div>
      </section>
    </>
  );
